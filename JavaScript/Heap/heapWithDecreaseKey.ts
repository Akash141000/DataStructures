...
export class NodeTreeElement {
  ...
  constructor(data: string, value: number, link: string) {
    this.data = data;
    this.value = value;
    this.link = link;
  }
...
export const removeElementMinHeap = () => {
  ...
  let swap = new NodeTreeElement("Null", 0, "Null");
...
export const decreaseKey = (
  nodeData: string,
  nodeValue: number,
  link: string
) => {
  const elementIndex = minHeap.findIndex(
    (element) => element.data === nodeData
  );
  const node = minHeap[elementIndex];
...
const start = () => {
  ...
  const unsortedArray = [
    new NodeTreeElement("AB", 70, "NULL"),
    new NodeTreeElement("BD", 60, "NULL"),
    new NodeTreeElement("BC", 20, "NULL"),
    new NodeTreeElement("BE", 40, "NULL"),
    new NodeTreeElement("DC", 50, "NULL"),
    new NodeTreeElement("CE", 30, "NULL"),
    new NodeTreeElement("DE", 10, "NULL"),
  ];
